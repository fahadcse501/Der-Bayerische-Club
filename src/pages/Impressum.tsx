...
const ImpressumPage: React.FC = () => {
  return (
    <IonPage>
        ...
        <h3>Kontakt:</h3>
        <p>
          Telefon: <a href="tel:+498923888780">089-23 888 78 0</a><br />
          E-Mail: <a href="mailto:info@notar-riemenschneider.de">info@notar-riemenschneider.de</a>
        </p>
        ...
        <h3>Kontakt:</h3>
        <p>
          Telefon: <a href="tel:+498941119050">089-41 11 90 50</a><br />
          E-Mail: <a href="mailto:muenchen@langwieser.de">muenchen@langwieser.de</a>
        </p>

        <h2>Weitere verantwortliche Stelle (§ 18 Abs. 2 MStV)</h2>
        <p>
          Stephan Mayer<br />
          Ottostraße 4<br />
          80333 München
        ...
        <p>
          ...
          verhindern, indem Sie in Ihren Browser-Einstellungen "keine Cookies akzeptieren" wählen; wir weisen Sie jedoch
          darauf hin, dass Sie in diesem Fall gegebenenfalls nicht sämtliche Funktionen dieser Website voll umfänglich
          nutzen können. Durch die Nutzung dieser Website erklären Sie sich mit der Bearbeitung der über Sie erhobenen
